...
class Projects extends Model
{
  ...
  public static function getGlobalTrend($year)
  {
    ...
    $monthlyExpenses = DB::table('material_issues_items')
      ...
      ->selectRaw((DB::connection()->getDriverName() === 'sqlite' ? "strftime('%m', material_issues.posting_date)" : "MONTH(material_issues.posting_date)") . ' as month, SUM(material_issues_items.val_currency) as total')
      ->groupBy('month')
      ->pluck('total', 'month')
      ->toArray();
