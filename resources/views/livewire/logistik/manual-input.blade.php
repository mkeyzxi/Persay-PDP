<div class="min-h-screen bg-gray-50 p-6 transition-colors dark:bg-[#1e1e2e]">
    <div class="mx-auto max-w-7xl">
        ...
        <!-- Tab Navigation -->
        <div class="mb-6 rounded-xl bg-white p-2 shadow-lg dark:bg-[#2d2d3d]">
            <nav class="flex flex-wrap gap-2">
                <button wire:click="$set('activeTab', 'project')"
                    class="{{ $activeTab === 'project' ? 'bg-primary-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600' }} flex items-center gap-2 rounded-lg px-4 py-2 font-medium transition-colors">
                ...
                <button wire:click="$set('activeTab', 'material_issue')"
                    class="{{ $activeTab === 'material_issue' ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600' }} flex items-center gap-2 rounded-lg px-4 py-2 font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:hidden" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button wire:click="$set('activeTab', 'material')"
                    class="{{ $activeTab === 'material' ? 'bg-purple-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600' }} flex items-center gap-2 rounded-lg px-4 py-2 font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:hidden" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button wire:click="$set('activeTab', 'item')"
                    class="{{ $activeTab === 'item' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600' }} flex items-center gap-2 rounded-lg px-4 py-2 font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:hidden" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="rounded-xl bg-white p-6 shadow-lg dark:bg-[#2d2d3d]">
            ...
            @if ($activeTab === 'project')
                <div>
                    <h2 class="mb-4 flex items-center gap-2 text-xl font-semibold text-gray-800 dark:text-white">
                    ...
                    <form wire:submit.prevent="saveProject">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <!-- WBS Number -->
                            <div class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 dark:bg-gray-700/30">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nomor
                                    WBS</label>
                                <input type="text" wire:model="wbs_number"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-gray-500 focus:ring-2 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                    placeholder="WBS.001.002">
                            </div>

                            <!-- Vendor Name -->
                            <div class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 dark:bg-gray-700/30">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nama
                                    Vendor</label>
                            ...
                            <!-- Unit Code -->
                            <div class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 dark:bg-gray-700/30">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Unit
                                    Code</label>
                            ...
                            <!-- Fiscal Year -->
                            <div class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 dark:bg-gray-700/30">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Tahun
                                    Fiskal</label>
                            ...
                            <!-- Project Name -->
                            <div
                                class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 md:col-span-2 lg:col-span-3 dark:bg-gray-700/30">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nama
                                    Pekerjaan</label>
                ...
                <div>
                    ...
                    <form wire:submit.prevent="saveMaterialIssue">
                        ...
                        <div class="mb-6 rounded-lg border-2 border-green-400 bg-green-50 p-4 dark:bg-green-900/20">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <label class="flex cursor-pointer items-center gap-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Project yang
                                        Sudah Ada</span>
                                </label>
                                <label class="flex cursor-pointer items-center gap-2">
                                    <input type="radio" wire:model.live="mi_project_mode" value="new_project"
                                        class="text-green-600 focus:ring-green-500">
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Buat Project
                                        Baru</span>
                                </label>
                            </div>
                        </div>
                        ...
                        @if ($mi_project_mode === 'existing')
                            <div class="mb-6">
                                <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Pilih
                                    Project *</label>
                                <select wire:model.live="mi_selected_project_id"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-green-500 focus:ring-2 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                        ...
                        @else
                            ...
                            <div class="mb-6 rounded-lg border-2 border-blue-300 bg-blue-50 p-4 dark:bg-blue-900/20">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nomor
                                            SPK *</label>
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">WBS
                                            Number</label>
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nama
                                            Pekerjaan</label>
                        ...
                        <div class="mb-6">
                            <h4 class="mb-3 font-medium text-gray-800 dark:text-white">Data Material Issue</h4>
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                <div class="rounded-lg border-2 border-green-400 bg-green-50 p-3 dark:bg-green-900/20">
                                    ...
                                    <input type="text" wire:model="sap_doc_no"
                                        class="w-full rounded-lg border border-green-300 bg-white px-4 py-2 dark:border-green-600 dark:bg-gray-700 dark:text-white"
                            ...
                            <div
                                ...
                                <div class="mb-4 flex flex-wrap gap-4">
                                    <label class="flex cursor-pointer items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-700 dark:text-gray-300">Pilih Material yang
                                            Ada</span>
                                    </label>
                                    <label class="flex cursor-pointer items-center gap-2">
                                        <input type="radio" wire:model.live="mi_item_mode" value="new_material"
                                            class="text-orange-600 focus:ring-orange-500">
                                        <span class="text-sm text-gray-700 dark:text-gray-300">Buat Material
                                            Baru</span>
                                    </label>
                                </div>
                                ...
                                @if ($mi_item_mode === 'existing_material')
                                    <div class="mb-4">
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Pilih
                                            Material *</label>
                                ...
                                @else
                                    <div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div>
                                            <label
                                                class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Kode
                                                Material *</label>
                                        ...
                                        <div>
                                            <label
                                                class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Deskripsi
                                                *</label>
                                        ...
                                        <div>
                                            <label
                                                class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Satuan</label>
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Qty
                                            *</label>
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Nilai
                                            (Rp)</label>
                    ...
                    <div class="mb-6 rounded-lg border-2 border-purple-400 bg-purple-50 p-4 dark:bg-purple-900/20">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <label class="flex cursor-pointer items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Tambah Material
                                    Baru</span>
                            </label>
                            <label class="flex cursor-pointer items-center gap-2">
                                <input type="radio" wire:model.live="material_mode" value="edit"
                                    class="text-purple-600 focus:ring-purple-500">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Edit Material yang
                                    Ada</span>
                            </label>
                            <label class="flex cursor-pointer items-center gap-2">
                                <input type="radio" wire:model.live="material_mode" value="add_to_mi"
                                    class="text-purple-600 focus:ring-purple-500">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Tambah Material ke
                                    MI</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="saveMaterial">
                        ...
                        @if ($material_mode === 'new' || $material_mode === 'edit')
                            <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div class="rounded-lg border-2 border-gray-300 bg-gray-50 p-3 dark:bg-gray-700/30">
                                    <label
                                        class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Satuan
                                        (UoM)</label>
                        ...
                        @if ($material_mode === 'add_to_mi')
                            <div class="mb-6">
                                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Pilih
            ...
            @if ($activeTab === 'item')
                <div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <label class="flex cursor-pointer items-center gap-2">
                                <input type="radio" wire:model.live="item_mi_mode" value="existing_mi"
                                    class="text-orange-600 focus:ring-orange-500">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Material Issue yang
                                    Sudah Ada</span>
                            </label>
                            <label class="flex cursor-pointer items-center gap-2">
                                <input type="radio" wire:model.live="item_mi_mode" value="new_mi"
                                    class="text-orange-600 focus:ring-orange-500">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Buat Material Issue
                                    Baru</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="saveItem">
                        ...
                        @else
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">No.
                                            Dokumen TUG *</label>
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal
                                            Posting *</label>
                            ...
                            <div class="mb-4 flex flex-wrap gap-4">
                                ...
                                <label class="flex cursor-pointer items-center gap-2">
                                    <input type="radio" wire:model.live="item_material_mode" value="new"
                                        class="text-purple-600 focus:ring-purple-500">
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Buat Material Baru</span>
                                </label>
                            </div>
                        ...
                        <!-- Item Details -->
                        <div class="mb-6">
                            <h4 class="mb-3 font-medium text-gray-800 dark:text-white">Detail Item</h4>
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div
                                    class="rounded-lg border-2 border-orange-400 bg-orange-50 p-3 dark:bg-orange-900/20">
                                    <label
