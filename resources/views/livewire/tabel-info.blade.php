    ...
    <div class="mx-auto max-w-full">
        ...
        <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            ...
            <div class="flex gap-4">
                <div
                    class="rounded-lg border border-gray-100 bg-white px-4 py-2 shadow-sm dark:border-gray-700 dark:bg-[#2d2d3d]">
        ...
        <div
            class="overflow-hidden rounded-xl bg-white shadow-md ring-1 ring-gray-200 dark:bg-[#2d2d3d] dark:ring-gray-700">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative min-w-[300px]">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search"
                            ...
                            class="w-full rounded-lg border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm focus:border-[#5A6ACF] focus:ring-[#5A6ACF]/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                    </div>

                    <select wire:model.live="sortField"
                        class="rounded-lg border-gray-200 bg-gray-50 py-2 text-sm focus:border-[#5A6ACF] focus:ring-[#5A6ACF]/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[1400px] table-auto text-left text-sm">
                    <thead
                        class="border-b border-gray-100 bg-gray-50/50 text-xs uppercase tracking-wider text-gray-500 dark:border-gray-700 dark:bg-gray-800/50 dark:text-gray-400">
                        <tr>
                    ...
                    <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-gray-700 dark:text-gray-300">
                        @forelse($projects as $p)
                            <tr class="group transition-colors hover:bg-blue-50/30 dark:hover:bg-blue-900/10">
                                ...
                                <td
                                    class="whitespace-nowrap px-4 py-4 text-right font-mono font-medium text-gray-900 dark:text-white">
                                    {{ number_format($p->saldo_pdp, 0, ',', '.') }}
                                </td>
                            ...
                            <tr>
                                <td colspan="12" class="px-4 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="mt-4 font-medium text-gray-500 dark:text-gray-400">Tidak ada data
                                            yang ditemukan</p>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="border-t border-gray-100 bg-gray-50/50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800/30">
                {{ $projects->links() }}
            </div>
        </div>
