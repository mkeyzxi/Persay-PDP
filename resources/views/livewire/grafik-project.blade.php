<div class="p-4 bg-white dark:bg-gray-800 h-full flex flex-col rounded-xl shadow-sm">
    <div class="mb-4 flex justify-between items-center border-b pb-4 dark:border-gray-700">
        <div>
            <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">
                Arus Kas Global (Realtime)
            </h3>
            <p class="text-xs text-gray-500 mt-1">
                Total Anggaran Dikelola:
        ...
        <select wire:model.live="year" class="text-sm font-medium border rounded-lg px-3 py-2 bg-gray-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 focus:ring-2 focus:ring-blue-500">
    ...
    <div
        class="w-full flex-1 min-h-[350px] relative"
        x-data="financeChart({
